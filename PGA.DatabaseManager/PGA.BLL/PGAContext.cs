...
namespace PGA.BLL
{
    ...
    partial void InsertStack(Stack instance);
    partial void UpdateStack(Stack instance);
    partial void DeleteStack(Stack instance);
    ...
    partial void DeleteTasks(Tasks instance);
		...
		public System.Data.Linq.Table<Stack> Stack
		{
			get
			{
				return this.GetTable<Stack>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute()]
	public partial class Stack : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIdChanging(int value);
    partial void OnIdChanged();
    partial void OnDwgidChanging(int value);
    partial void OnDwgidChanged();
    ...
    partial void OnErrorMessageChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="dwgid", Storage="_Dwgid", DbType="Int NOT NULL")]
		public int Dwgid
		{
			get
			{
			...
			set
			{
				if ((this._Dwgid != value))
				{
					this.OnDwgidChanging(value);
					this.SendPropertyChanging();
					this._Dwgid = value;
					this.SendPropertyChanged("Dwgid");
					this.OnDwgidChanged();
				}
			}
		}
