    ...
    public static class Active
        {
            ...
            {
                get { return Acad.HostApplicationServices.WorkingDatabase; }
            }

            public static Acad.Transaction StartTransaction()
            {
                return Acad.HostApplicationServices.WorkingDatabase.TransactionManager.StartTransaction();
            }
